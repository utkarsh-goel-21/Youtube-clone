...
// Simple static file serving with proper CORS headers
// Complex streaming was causing issues on Render
app.use('/uploads', (req, res, next) => {
  ...
  // For video files, set proper content type
  ...
  setHeaders: (res, filepath) => {
    // Express.static handles range requests automatically
